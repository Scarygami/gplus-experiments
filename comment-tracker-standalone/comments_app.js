...
(function (window) {
  "use strict";
  var colors, posts, color_count, comments, oldest_first, yt_api_key, PLUS_POST, YT_POST, PLUS_SEARCH, TWITTER_SEARCH, api_key, use_colors, search_id;
  ...
  function Comment(post, comment_id, author_name, author_pic, published, updated, content, url) {
    ...
    this.get_contents = function () {
      ...
      str_comment += "<div class=\"comment_time\"><a href=\"" + this.url + "\" target=\"_blank\">" + this.published.nice_date() + "</a></div>";
  ...
  function Post(post_type, post_user, post_id, color, cb, chk_reshares, chk_reshare) {
    ...
    if (this.post_type === PLUS_POST) {
      request = gapi.client.plus.activities.list({"userId": post_user, "collection": "public", "maxResults": max_results});
        ...
        if (resp.items) {
          ...
          if (this_post.activity_id === "") {
            ...
            if (chk_reshares) {
              ...
              request = gapi.client.plus.people.listByActivity({"activityId": org_id, "collection": "resharers", "maxResults": 25});
              request.execute(function (resp) {
          ...
          setTimeout(function () { cb(this_post.post_user, this_post.post_id); }, 10);
        } else {
    ...
    this.get_contents = function () {
      ...
      if (this_post.activity_id !== "") {
        if (this_post.post_type !== TWITTER_SEARCH && this_post.post_type !== PLUS_SEARCH) {
          str_tmp += "<div class=\"post_time\"><a href=\"" + this.url + "\" target=\"_blank\">" + published.nice_date() + "</a></div>";
          str_tmp += "<b>" + author_name + "</b><br>";
        } else {
          str_tmp += "<div class=\"post_time\"><a href=\"" + this.url + "\" target=\"_blank\">Search</a></div>";
        }
      }
    ...
    this.check_comments = function (cb) {
      ...
      if (this_post.activity_id !== "") {
        ...
        if (this.post_type === PLUS_POST) {
          this.checking = true;
          request = gapi.client.plus.comments.list({"activityId": this_post.activity_id, "maxResults": 100, "sortOrder": "descending"});
          request.execute(function (resp) {
            ...
            setTimeout(function () { cb(comments); }, 10);
            this_post.checking = false;
          });
        }
        ...
        if (this.post_type === YT_POST) {
          ...
          try {
            ...
            setTimeout(function () { this_post.checking = false; }, 5000);
          } catch (e) {
